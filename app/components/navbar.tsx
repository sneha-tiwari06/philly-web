      ...
      <div className="header">
        <div className="topLinks">
          <div className="container-xxl d-flex justify-content-between align-items-center">
            ...
            <ul className="list-inline d-flex gap-1">
              ...
              <li>
                <small>4.8 / 5 Based on 725 reviews</small>
              </li>
            </ul>
        ...
        <div className="container-xxl">
          <div className="mainHeader">
            <div className="logo">
              <Link href="./">Philly City Tours</Link>
            </div>
            <nav className="navi d-flex align-items-center gap-3">
              <ul className="list-inline d-none d-lg-flex">
                ...
                <li className="position-relative">
                  <Link href="/event-party-philly-city">
            ...
            <div className="cart-btnBox d-none d-lg-flex align-items-center gap-2">
              <Link href="/cart" className="position-relative d-block">
                <span className="badge bg-danger rounded-pill position-absolute top-0 start-100 translate-middle">
                  1
                </span>
                <i className="fa fa-shopping-cart icon-circular"></i>
              </Link>
              <div className="readmore mt-0 w-auto">
                <Link href="#" className="button">
                  Get In Touch <i className="fa fa-paper-plane"></i>
                </Link>
              </div>
